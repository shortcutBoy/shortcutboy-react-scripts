...
### Publish:
`cd` to the react-scripts directory from your terminal like so: `./packages/react-scripts`, and then login npm and publish your customized react-scripts.
...
- [Customizing react-script](https://auth0.com/blog/how-to-configure-create-react-app/) – How to customize react-script.
